...
module.exports = {
SESSION_ID: process.env.SESSION_ID === undefined ? '𝙰𝚂𝙸𝚃𝙷𝙰-𝙼𝙳=u3gnVLoB#n2BFM2meaUduuulWQywCWosC6ctEfE1l6gHvfTpCMAY' : process.env.SESSION_ID,
PREFIX: process.env.PREFIX || '#' ,
ALIVE_MSG: process.env.ALIVE_MSG === undefined ? "*Hi , Juice pilado mosambi ka!!*" : process.env.ALIVE_MSG,
